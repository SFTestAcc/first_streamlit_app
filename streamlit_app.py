...
#Querying trial account information
...
#Taking input from user about fruit to add to the list
fruit_to_add = streamlit.text_input("Which fruit would you like to add?")
